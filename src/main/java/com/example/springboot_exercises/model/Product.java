...
import com.example.springboot_exercises.model.dto.ProductRequestDTOAdmin;
...
public class Product {
    ...
    private Product toEntity(ProductRequestDTOAdmin request){
        Product product = new Product();
        ...
        if(request.getInternalStatus() != null && !request.getInternalStatus().isBlank()){
